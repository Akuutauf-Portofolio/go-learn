...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        {{-- <li class="menu-item">
            ...
            <ul class="menu-sub">
                <li class="menu-item">
                    <a href="{{ route('login.page') }}" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Login</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('register.page') }}" class="menu-link" target="_blank">
                        <div data-i18n="Basic">Register</div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('forgot-password.page') }}" class="menu-link" target="_blank">
