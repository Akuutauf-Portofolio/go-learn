...
<head>
    ...
    <title>Forgot Password | Project App</title>
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card card-hover">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Masukkan email anda, dan kami akan mengirimkan verifikasi </p>
                        <form id="formAuthentication" class="mb-3" action="{{ route('dashboard.page') }}"
                            ...
                            <button class="btn btn-primary d-grid w-100">Kirim kode reset</button>
                        </form>
